    ...
    <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
        ...
        <div class="w-full">
            ...
            <input
                v-model="title"
                type="text"
                placeholder="Digite a sua tarefa" class="bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3"
